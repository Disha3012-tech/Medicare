...
export default function AppointmentFilter({
  ...
  const set = <K extends keyof ApptFilterState>(
    key: K,
    value: ApptFilterState[K]
  ) => {
    onChange({
      ...filter,
      [key]: value,
      ...
      <div className="flex items-center gap-3 flex-wrap">
        <div className="relative flex-1 min-w-48">
          ...
          <input
            ...
            placeholder="Search by reason or appointment type..."
        ...
        <select
          value={filter.sort}
          onChange={(e) =>
            set("sort", e.target.value as ApptFilterState["sort"])
          }
